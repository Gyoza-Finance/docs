      ...
      <div className="container">
        ...
        <div className={styles.buttons}>
          <Link
            ...
            to={userDocsUrl}>
            <Translate id="homepage.userDocs">Gyoza User Docs</Translate>
          </Link>
        </div>
        <br />
        <br />
        <div className={styles.buttons}>
          <Link
            className="button button--secondary button--lg"
            to={techDocsUrl}>
            <Translate id="homepage.technicalDocs">Gyoza Technical Docs</Translate>
          </Link>
        </div>
      </div>
    </header>
...
export default function Home() {
  ...
  return (
    <Layout
      ...
      description="Learn about the Gyoza protocol.">
      <HomepageHeader />
      <main>
        <HomepageFeatures />
      </main>
